...
/* config */
#define CONFIG_XENO_BUILD_ARGS " 'CFLAGS=-march=armv7-a -mfpu=vfp3 -mfloat-abi=hard' 'LDFLAGS=-march=armv7-a' '--build=i686-pc-linux-gnu' '--host=arm-none-linux-gnueabi' '--with-core=cobalt' '--enable-smp' '--enable-tls' 'CC=arm-linux-gnueabihf-gcc' 'LD=arm-linux-gnueabihf-ld' 'build_alias=i686-pc-linux-gnu' 'host_alias=arm-none-linux-gnueabi'"
...
#define PACKAGE_STRING "Xenomai 3.1"
